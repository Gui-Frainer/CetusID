...
def execute_processing(testing_folder,sample_rate, location_models, weights_name_CNN1, weights_name_CNN2, time_to_extract, prediction_folder, convert_to_spectrograms, build_training_files_list, execute_listing_folders, batch_number, network_CNN1, network_CNN2,network_CNN1_TF, network_CNN2_TF,species_dir,dpi,real_start_time,time_within_detections, verbose):
    ...
    with open(testing_files) as fp:
            ...
            while line:
                ...
                model_prediction_CNN1, model_prediction_CNN2 = execute_batches(test_file_audio, audio_length, file_name, time_to_extract, sample_rate, location_models, weights_name_CNN1, weights_name_CNN2, batch_number,testing_folder,convert_to_spectrograms,network_CNN1,network_CNN2,species_dir,dpi)
...
def execute_batches(audio, audio_length, file_name, time_to_extract, sample_rate, location_models, weights_name_CNN1, weights_name_CNN2, batch_number,testing_folder,convert_to_spectrograms,network_CNN1,network_CNN2,species_dir,dpi):
    ...
    for i in range(batch_number):
        ...
        batch_prediction_CNN1,batch_prediction_CNN2  = predict(audio, start_index, end_index, time_to_extract, sample_rate, location_models, weights_name_CNN1, weights_name_CNN2,testing_folder,convert_to_spectrograms,network_CNN1,network_CNN2,species_dir,dpi)
...
def predict(audio_test, start_index, end_index, time_to_extract, sample_rate, location_models, weights_name_CNN1, weights_name_CNN2,testing_folder,convert_to_spectrograms,network_CNN1,network_CNN2,species_dir,dpi):
    ...
    model_CNN1 = network_CNN1(image_size)
    
    model_CNN1.load_weights(location_models + weights_name_CNN1)

    model_CNN2 = network_CNN2(image_size,species_dir)
